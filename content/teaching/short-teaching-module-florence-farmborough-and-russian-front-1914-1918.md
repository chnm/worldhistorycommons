---
title: "Short Teaching Module: Florence Farmborough and the Russian Front, 1914-1918"
doc_type: teaching
drupal_node_id: 37
url: /short-teaching-module-florence-farmborough-and-russian-front-1914-1918
...
Farmborough’s diary works well because it divides easily into short segments and is not difficult to understand because it uses modern language. Farmborough was an English nurse working on the Russian front. Her diary contains many descriptive, lively accounts of the war and the very active role played by women, both in the traditional role as caretakers of the wounded, but also as fighters. The primary sources referenced in this module can be viewed in the Primary Sources folder below. Click on the images or text for more information about the source.

This short teaching module includes suggestions for discussing and engaging with the one primary source.

## Primary Sources

### [Florence Farmborough’s Journal](/florence-farmboroughs-journal)
...
Eric Martone is a world history teacher at John F. Kennedy High School, Waterbury, Connecticut.

---
title: "Short Teaching Module: Surnames and Nationality"
doc_type: teaching
drupal_node_id: 1713
url: /short-teaching-module-surnames-and-nationality
...
Images of 1989 tend to center on dramatic events in Berlin, Warsaw, Prague, or other major East European cities. However, many of the changes in Eastern Europe and the world were far more subtle but no less important. This teaching module explores a new law passed in Italy in 1991, which was also an attempt to limit the the abuses of Communism as much as a regime change.The primary sources referenced in this module can be viewed in the Primary Sources folder below. Click on the images or text for more information about the source.

This short teaching module includes historical context and reflections on student engagement with the one primary source.

## Primary Sources

### [Provision for the Restatement of Names and Surnames](/provision-restatement-names-and-surnames)
...
Maura Hametz received her PhD from Brandeis University, and was previously a history professor at Old Dominion University. Her research specialties include Modern European History and transnational studies of nationalism, Jewish studies, and women’s and gender studies.

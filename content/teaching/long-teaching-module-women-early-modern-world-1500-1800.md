---
title: "Long Teaching Module: Women in the Early Modern World, 1500-1800"
doc_type: teaching
drupal_node_id: 1927
url: /long-teaching-module-women-early-modern-world-1500-1800
image: /images/Malleus_maleficarum_thumbnail.jpeg
authors: 
...
related_sources:
  - link: "/malleus-maleficarum-witch-hunter-manual"
    image: "/images/Malleus_maleficarum_thumbnail.jpeg"
    alt: "Title page of witch hunter manual, Malleus Maleficarum"
  ...
  - link: "/early-modern-period-fiction-gargantua-and-pantagruel"
    image: "/images/Icons-Document-thumbnail_391.jpg"
...
### [Malleus Maleficarum, Witch Hunter Manual](/malleus-maleficarum-witch-hunter-manual)
...
### [The Voyages and Adventures of Ferdinand Mendez Pinto](/voyages-and-adventures-ferdinand-mendez-pinto)
...
### [Early Modern Period: Nonfiction, Confucian Doctrine](/early-modern-period-nonfiction-confucian-doctrine)
...
### [Early Modern Period: Petition, Ming China](/early-modern-period-petition-ming-china)
...
### [Early Modern Period: Autobiography, Bahina Bai](/early-modern-period-autobiography-bahina-bai)
...
### [Letters of Lady Mary Wortley Montagu](/letters-lady-mary-wortley-montagu)
...
### [Susanna and the Elders](/susanna-and-elders)
...
5. **Homework:** Have the students examine the two visual sources: Source 6: Painting, The True Woman and Source 12: Painting, Susanna and the Elders. You may want to print out for them the annotations for these two sources in order to establish context for the period of study, but it is also useful to have them look at the sources alone.

**Day 2: European Sources**

6. Split the class into two groups. Have each group perform the Fleming’s Model on each source, and write it down. (15-20 minutes) Depending on the class size, you may want to give two groups one painting, and two the other one.
7. Next, have each group present some of their findings to the class. (15-20 minutes) Your conclusions should lead you to surmise that each of these sources depict women in both similar and different ways. See the source annotations for some of these differences. Depending on the class level you might want to place an emphasis on more difficult concepts for comparison. Have students list these differences on the board.
8. After this, pass out the second stapled packet that includes the non-European sources. Have the students chose one non-European source. Have the students fill out a Primary Source Analysis Worksheet: Texts for their non-European source.
9. **Homework:** Using this worksheet, write a one-page response on how their image from Europe compares in its depiction of women to the non-European source. They need a thesis statement and evidence from each source in order to support their points.

**Day 3: Non-European Sources, Conclusions**

10. Have a class discussion about the students' findings. Read some of the written non-European sources out loud during the class. Make a list of similarities and differences between these worlds. What in the end does it tell us about women during the Early Modern Period?
